...
function storePatient(array $request){
    ...
    if(!is_null(DB::getConnection())){
        ...
        $sql = "INSERT INTO 
         patients(patient_first_name,patient_last_name,patient_email,patient_contact,patient_gender,patient_password)
         values('$first_name','$last_name','$email','$contact','$gender','$password')";
