							...
							<table class="table table-striped custom-table">
                                ...
                                <?php foreach($appointments as $appointment) :?>
									<tr>
										...
										<td><button class="custom-badge status-green">Approved</button></td>
										<?php endif ?>

										<?php if($status=="pending"): ?>
                                        <td><button class="custom-badge status-orange">Pending</button></td>
                                        <?php endif ?>

                                        <?php if($status=="rejected"): ?>
                                        <td><button class="custom-badge status-red">Rejected</button></td>
                                        <?php endif ?>
                                        ...
                                        <td class="text-right">
                                         <div class="dropdown dropdown-action">
                                           ...
                                           <?php if($status=="rejected"): ?>
                                            ...
                                            <a class="dropdown-item" href="actions/action.php?apt_action=true&action=approve&id=<?php echo ($appointment["appointment_id"]) ?>">Approve</a></td>
